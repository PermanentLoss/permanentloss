...
library MarginVault {
    ...
    function addShort(
        ...
        if (
            ...
            _vault.shortAmounts[_index] = _vault.shortAmounts[_index].add(
                _amount
            );
            _vault.shortOtokens[_index] = _shortOtoken;
        }
    ...
    function addLong(
        ...
        if (
            ...
            _vault.longAmounts[_index] = _vault.longAmounts[_index].add(
                _amount
            );
            _vault.longOtokens[_index] = _longOtoken;
        }
    ...
    function addCollateral(
        ...
        if (
            ...
            _vault.collateralAmounts[_index] = _vault.collateralAmounts[_index]
                .add(_amount);
            _vault.collateralAssets[_index] = _collateralAsset;
        }
    }
    ...
    function removeCollateral(
        ...
        _vault.collateralAmounts[_index] = _vault.collateralAmounts[_index].sub(
            _amount
        );
